...
function display_filter_form( $available_categories, $available_sizes = array() ) {
    ...
    echo '<div class="cclist-accordion-trigger" data-target="filter-product-form">';
    echo '<h2>Filter Products</h2>';
    echo '</div>';
    echo '<div id="filter-product-form" class="cclist-accordion-content" style="display: none;">';
    echo '<form method="get" class="cclist-grid-form">';
    ...
    echo '<div class="cclist-search-section">';
    ...
    // Options and Buttons
    echo '<div class="cclist-options-section">';
    ...
    echo '<div id="cclist-discount-only-container">';
